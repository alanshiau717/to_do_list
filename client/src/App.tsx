...
export function AppFunctional(){
  const {loading, error, data} = useQuery(IsValidUserSessionDocument)
  const isAuthenticating = useSelector((state: any) => state.usersession.isAuthenticating)
  const isAuthenticated = useSelector((state: any) => state.usersession.isAuthenticated)
