...
import {Navbar, Nav, Row, Container, Col, Accordion, AccordionContext, useAccordionToggle, Card} from "react-bootstrap";
...
class SideBar extends Component<Props, State> {
    ...
    render() {
        ...
        const testDropDownMenu = Array.of({name: "test", function: () => {console.log('hello world')}})
        // @ts-ignore
        return (
                    ...
                    return folder.lists.map((list) => {
                        return (
                            ...
                            this.props.userDetails.inbox.toString() && (
                                <SidebarElementRender icon = {Inbox} dropDownMenu={testDropDownMenu} name = "Inbox"/>
                            )
                        );
                    });
                })}
                <hr className={"hrLine"}></hr>
                <ProjectsAccordion folders = {this.props.folders} userDetails={this.props.userDetails}/>
            </div>
